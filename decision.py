...
from calculate_data import get_interpolated_fund_data, fourier_worm_rolling, real_data_direction,fourier_worm_rolling_classic,get_df
import pandas as pd
...
def get_correct_rate(fund_code:str = '005698',obeserve_start_date:str='2025-06-24',observe_end_date:str='2025-09-06',expected_steps=20):
    ...
    for date in dates:
        ...
        fourier_rate=fourier_worm_rolling_classic(get_df('000216'), '2024-08-01', '2025-9-29', sampling_frequency='D', cycles=284, window_size=120, prediction_steps=10, add_trend=True)
        time+=1
